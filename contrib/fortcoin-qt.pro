...
RESOURCES += src/qt/fortcoin.qrc src/qt/fortcoin_locale.qrc

TRANSLATIONS += src/qt/locale/fortcoin_bg.ts \
                src/qt/locale/fortcoin_de.ts \
                src/qt/locale/fortcoin_en.ts \
                src/qt/locale/fortcoin_es.ts \
                src/qt/locale/fortcoin_fi.ts \
                src/qt/locale/fortcoin_fr.ts \
                src/qt/locale/fortcoin_it.ts \
                src/qt/locale/fortcoin_ja.ts \
                src/qt/locale/fortcoin_pl.ts \
                src/qt/locale/fortcoin_pt.ts \
                src/qt/locale/fortcoin_ru.ts \
                src/qt/locale/fortcoin_sk.ts \
                src/qt/locale/fortcoin_sv.ts \
                src/qt/locale/fortcoin_vi.ts \
                src/qt/locale/fortcoin_zh_CN.ts \
                src/qt/locale/fortcoin_zh_TW.ts
