...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Fortcoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Fortcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Fortcoin features */
        {"fortcoin", "masternode", &masternode, true, true, false},
        {"fortcoin", "masternodelist", &masternodelist, true, true, false},
        {"fortcoin", "mnbudget", &mnbudget, true, true, false},
        {"fortcoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"fortcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fortcoin", "mnsync", &mnsync, true, true, false},
        {"fortcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"fortcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use fortcoind, or the -server option to fortcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> fortcoin-cli " + methodname + " " + args + "\n";
}
