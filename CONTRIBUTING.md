Contributing to Fortcoin Core
============================

The Fortcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Fortcoin Core project, and is not to be
confused with overall Fortcoin Network Protocol consensus changes.

Whether a pull request is merged into Fortcoin Core rests with the project merge
...
Patches that change Fortcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Fortcoin consensus, it must have been
...
The project leader is the release manager for each Fortcoin Core release.
