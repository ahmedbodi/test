...
Fortcoin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<fortcoin_address\> \<monthly_payment_fortcoin\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ Fortcoin, _12_ times over the course of a year totaling _24000_ Fortcoin.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<fortcoin_address\> \<monthly_payment_fortcoin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` Fortcoin.
 ...
 * vote-many          - Vote on a Fortcoin initiative
 * vote-alias         - Vote on a Fortcoin initiative
 * vote               - Vote on a Fortcoin initiative/budget
