...
In order to support loading of multiple wallets in fortcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fortcoin.cpp.
...
Changes to fortcoin.cpp
----------------------
fortcoin.cpp is the entry point into fortcoin-qt, and as such, will require some minor modifications to provide hooks for
