...
/** Utility functions used by the Fortcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Fortcoin addresses in monospace font
...
// Parse "fortcoin:" URI into recipient object, return true on successful parsing
