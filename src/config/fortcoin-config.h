/* src/config/fortcoin-config.h.  Generated from fortcoin-config.h.in by configure.  */
/* src/config/fortcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef FORT_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.fortcoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Fortcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Fortcoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "fortcoin"
