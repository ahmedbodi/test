...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Fortcoin Core"),
     ...
     * override -datadir in the fortcoin.conf file in the default data directory
     * (to be consistent with fortcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
