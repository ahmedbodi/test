...
This means one can have an always-on fortcoind instance running, and another local fortcoind/fortcoin-qt instance which connects to this node and receives blocks from it.
