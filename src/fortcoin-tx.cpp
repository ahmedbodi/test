...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Fortcoin Core fortcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  fortcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fortcoin transaction") + "\n" +
                               "  fortcoin-tx [options] -create [commands]   " + _("Create hex-encoded fortcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded fortcoin transaction
