                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Fortcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Fortcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fortcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Fortcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Fortcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Fortcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Fortcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Fortcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Fortcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Fortcoin Core help message to get a list with possible Fortcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Fortcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Fortcoin network", "", count));
}
...
{
    QString strTitle = tr("Fortcoin Core"); // default title
