...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/Fortcoin-Project/Fortcoin/blob/master/doc/translation_process.md#synchronising-translations).
...
### Fortcoin maintainers/release engineers, suggestion for writing release notes
...
### Build and sign Fortcoin Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit fortcoin=v${VERSION} ../fortcoin/contrib/gitian-descriptors/gitian-osx.yml
...
Codesigner only: Sign the osx binary:
    ...
    transfer fortcoin-osx-unsigned.tar.gz to osx for signing
...
- Detached signatures will then be committed to the [fortcoin-detached-sigs](https://github.com/Fortcoin-Project/fortcoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/Fortcoin-Project/Fortcoin/releases/new) with a link to the archived release notes.
